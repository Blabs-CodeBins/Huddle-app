...
<style>
   ...
   #starttodaydaysContainer .panel.panel-default, .panel.panel-default.TodaystodoContainer {
            ...
            <div class="col-md-12 tw-flex tw-justify-between tw-mb-3">
                ...
                <div class="edit-button">
                    <?php if ($todaysTodoSubmitted || !$todaysTasks): ?>
                        <a href="<?php echo admin_url(); ?>todo/ViewMyTodos" class="btn btn-primary btn-sm pull-right">
