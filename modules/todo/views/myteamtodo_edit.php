...
<div id="wrapper">
    <div class="content" id="mytodos-content">
        <div class="row tw-mb-8 ">
            <div class="col-md-12 tw-flex tw-justify-between tw-mb-3">
                <div class="heading-title col-md-4">
                    <h3 class="tw-font-semibold tw-text-gray-800 tw-m-0">
                        Today's To Do Plan of <?php echo (isset($staffull_name)) ? $staffull_name : '[my name]'; ?>
                    </h3>
                </div>
                <?php 
                ...
                <div class="edit-button">
                    <?php if ($todaysTodoSubmitted || !$todaysTasks): ?>
                        <a href="<?php echo admin_url(); ?>todo/myteamtodos" class="btn btn-primary btn-sm pull-right">
        ...
        <div class="row">
                                                ...
                                                <div class="col-md-11 content-sec">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 tw-text-neutral-600 mtop10 tw-text-sm">
                                                            <div class="tw-flex -tw-space-x-1">
                                                                <a href="<?php echo admin_url(); ?>profile/<?= $staffid ?>">
                                                                    <?php echo staff_profile_image($staffid, ['img', 'img-responsive', 'staff-profile-image-small', 'tw-h-5 tw-w-5 tw-inline-block tw-rounded-full tw-ring-2 tw-ring-white'],'small', ['data-toggle' => 'tooltip','data-title'  => $staffull_name,]); ?>
                                                        ...
                                                        <div class="col-md-8 text-right tw-text-neutral-500 mtop10 tw-text-sm">
                                                            ...
                                                            &nbsp;
                                                            <span class="<?php echo ($task['startdate'] < date('Y-m-d')) ? 'text-danger' : 'tw-text-neutral-500';?>" data-toggle="tooltip" title="" data-original-title="Start Date">
            ...
            <div class="col-md-6 right-card">
                <div class="row">
                            ...
                            <div class="panel-body scrollable-container">
                                ...
                                <div class="panel-group tw-mt-3">
                                                ...
                                                <div class="col-md-11 content-sec">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 text-right tw-text-neutral-500 mtop10 tw-text-sm">
                                                            ...
                                                            &nbsp;
                                                            <span class="<?php echo ($task['start_date'] < date('Y-m-d')) ? 'text-danger' : 'tw-text-neutral-500';?>" data-toggle="tooltip" title="" data-original-title="Start Date">
                                                                <i class="fa fa-calendar" aria-hidden="true"></i>
                                    ...
                                    <?php if(count($overdueTask) == 0): ?>
                                        <div class="col-md-12">
                                            <div class="alert alert-info d-flex align-items-center tw-mt-3 tw-p-1 tw-mb-0" role="alert">
                                                <i class="glyphicon glyphicon-info-sign" style="margin-right: 8px;"></i>
                                ...
                                <div class="panel-group tw-mt-3" id="huddlerTodos">
                                    ...
                                    <?php foreach ($todaysToDo as $task): ?>
                                        <div class="panel panel-default" id="taskpanelLeft<?php echo $task['task_id']; ?>">
                                            <div class="row tw-flex tw-justify-between">
                                            <?php if(date('Y-m-d', strtotime($task['start_date'])) != date('Y-m-d') && $task['status'] == 2) { ?>
                                                <div class="col-md-1 leftarrow">
                                                    <span data-taskid="<?php echo $task['task_id']; ?>" class="tw-text-neutral-500" data-toggle="tooltip" title="Remove">
                    ...
                    <?php if ($isProjectManager || $istoplinemanager ) { ?>
                        <div class="col-md-12">
                            <div class="panel_s">
                                <div class="panel-body scrollable-container">
                                    <div class="page-header tw-mt-0 tw-mb-0 tw-pb-1 sticky-heading">
        ...
        <div class="row">
            <div class="btn-bottom-toolbar text-right">
                <button type="submit" class="btn btn-success" id="submitmytodayplan">
                    Update Today's Plan
                </button>
            </div>
            <!-- <div class="col-md-offset-5 col-md-5 tw-mb-5 tw-pb-3">
                <button type="submit" class="btn btn-success" id="submitmytodayplan" style="font-size: 19.45px;">Submit My Today's Plan</button>
            </div> -->
        </div>
        <!-- Modal box -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">Modal title</h4>
                    </div>
                                    ...
                                    <div class="row tw-flex tw-justify-between">
                                        ...
                                        <div class="col-md-11 content-sec">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 tw-text-neutral-600 mtop10 tw-text-sm">
                                                    <div class="tw-flex -tw-space-x-1">
                                                        <a href="<?php echo admin_url(); ?>profile/<?= $staffid ?>">
                                                            ${task.img_tag}
                                                        </a>
                                                ...
                                                <div class="col-md-10 text-right tw-text-neutral-500 mtop10 tw-text-sm">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        setTimeout(function() {
                            window.location.href='<?php echo admin_url(); ?>todo/myteamtodos';
                        }, 1000);
                    } else {
                        alert_float("danger", response.message);
                    }
